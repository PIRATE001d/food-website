                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM regtable order by ID desc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['Fname'].'</td>	
																								...
																								<td>'.$rows['city'].'</td>
																									 ...
																									 <a href="update_users.php?user_upd='.$rows['ID'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
																		}	
														}
											?>
